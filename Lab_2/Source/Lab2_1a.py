...
def model_generate():
    ...
    seq_model.add(Dense(8,input_dim=8,init='normal',activation='relu'))
...
estmtr=krs_estmtr.fit(x_Train_data,y_Train_data,epochs= 20, batch_size= 160,callbacks=[tnsr_brd])
